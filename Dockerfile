...
RUN mkdir bio-medical-and-signal-processing-laboratory-coep

COPY src/ /bio-medical-and-signal-processing-laboratory-coep/src

WORKDIR ./bio-medical-and-signal-processing-laboratory-coep/src
